...
Jeremy Gold's code generates 1023-element series of ones and zeros, but, to match the amplitude of the carrier and number of samples in my code, I've had to tile it, repeat it and turn each 0 into a -1.
